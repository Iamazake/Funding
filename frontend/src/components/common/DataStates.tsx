...
export function EmptyState({ title = "Nenhum item encontrado", description = "Ajuste os filtros para consultar outros registros.", action }: { title?: string; description?: string; action?: ReactNode }) {
