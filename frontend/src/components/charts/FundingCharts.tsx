...
interface ChartCardProps { title: string; description: string; data: ChartPoint[]; variant?: "area" | "bar" | "donut"; height?: number; primaryLabel?: string; secondaryLabel?: string; }

export function ChartCard({ title, description, data, variant = "area", height = 290, primaryLabel = "Valor principal", secondaryLabel = "Valor comparativo" }: ChartCardProps) {
